...
class Database:
    ...
    def gather(self, query_obj, threshold_hashes, scaled, prefix):
        ...
        if self.dbtype == 'rocksdb':
            ...
            self.handle.fastmultigather_against(query_obj, threshold_hashes, scaled)
...
def main():
    ...
    against_db.gather(query_obj, 0, scaled, prefix)
    assert os.path.exists(f'{prefix}.gather.csv')
